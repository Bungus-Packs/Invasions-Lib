...
public class InvasionBeaconBlockEntityWaterRenderLayer extends GeoRenderLayer<InvasionBeaconBlockEntity> {

    public InvasionBeaconBlockEntityWaterRenderLayer(GeoRenderer<InvasionBeaconBlockEntity> renderer) {
        super(renderer);
    }
